...
def update_kerim_m3u():
    ...
    dosya_yolu = 'Kanallar/kerim.m3u'

    if not os.path.exists(dosya_yolu):
        print("Kanallar/kerim.m3u bulunamadı. Yeni oluşturuluyor...")
        ...
        if satir.startswith('#EXTINF'):
            ...
            if kanal_id in MANUEL_ID_LISTESI and i + 1 < len(satirlar):
                ...
                if yeni_url and eski_url != yeni_url:
                    print(f"🔁 {kanal_id} güncellendi (Kanallar/kerim.m3u).")
    ...
    print("✅ Kanallar/kerim.m3u başarıyla güncellendi!")
